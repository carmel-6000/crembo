        ...
        return (
            <Router>
                <div className="App">
                    ...
                    {/* <PrivateRoute exact
                        path="/list/children_rides"
                        component={() => (
                            <Grid modelMeta={'/api/meta/children_rides'} modelApi={'/api/ChildrenRides'} useShortFieldsSyntax={true} navHeader={this.updateNav} />
                        )}
                    /> */}
                ...
                <div className="container-fluid">
                    ...
                    <button tavindex="0" className="theme-button" type="button"> <i class="fas fa-cog fa-2x"></i> </button>
                        ...
                        <Breadcrumbs/>
                            ...
                            <PrivateRoute exact path="/table/:modelName" component={MatchTableToRoute} />
...
class NavBar extends Component {
    ...
    return(
        ...
        <div className="d-flex flex-row">
            ...
            <a className="brand p-2" href="/">Carmel6000</a>
        </div>
        {navHeader}
                            ...
                            <div className="nav-item">
                                {
                                    this.state.TableList.map((modelName) => {
                                        return (
                                        <a  href={"/table/" + modelName} className="nav-link">
